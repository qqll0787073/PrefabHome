...
export function BuyerPayments({ authMode }: BuyerPaymentsProps) {
    ...
    async function loadPayments() {
      ...
      try {
        if (authMode === "demo") {
          ...
          const paymentRows = await fetchBuyerPaymentRecords();
  ...
  return (
    <section className="quote-panel">
      ...
      <p className="form-notice">Buyer payment records are read-only. {externalPaymentRecordNotice()}</p>
