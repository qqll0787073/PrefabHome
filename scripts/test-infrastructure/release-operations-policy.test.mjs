...
test("migration baseline 0001 through 0026 is unchanged and 0027 is review-only", () => {
  ...
  assert.ok(changed === "" || changed === "supabase/migrations/0027_buyer_manufacturer_directory.sql");
});
